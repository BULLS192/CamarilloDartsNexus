...
const marker=JSON.parse(read('.v0920-robustness-applied'));assert.equal(marker.version,'0.9.20','final image must contain V0.9.20 patch execution marker');assert.equal(marker.source,'raw-state');assert.equal(marker.route,'/api/players/robustness');
...
console.log('V0.9.20 production-shaped robustness end-to-end contract passed: applied patch, raw-state endpoint, 192985 => R36');
