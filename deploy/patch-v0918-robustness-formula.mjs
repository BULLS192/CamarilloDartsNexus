...
player=player.replaceAll('EXTERNAL PLAYER INTELLIGENCE · V0.9.17','EXTERNAL PLAYER INTELLIGENCE · V0.9.20').replaceAll('EXTERNAL PLAYER INTELLIGENCE · V0.9.19','EXTERNAL PLAYER INTELLIGENCE · V0.9.20');
...
html=html.replaceAll('V0.9.17','V0.9.20').replaceAll('V0.9.18','V0.9.20').replaceAll('V0.9.19','V0.9.20').replaceAll('Camarillo Darts Nexus 0.9.17','Camarillo Darts Nexus 0.9.20').replaceAll('Camarillo Darts Nexus 0.9.18','Camarillo Darts Nexus 0.9.20').replaceAll('Camarillo Darts Nexus 0.9.19','Camarillo Darts Nexus 0.9.20');
fs.writeFileSync(paths.index,html);

const pkg=JSON.parse(fs.readFileSync(paths.pkg,'utf8'));
pkg.version='0.9.20';
pkg.description='Camarillo Darts Nexus fixed robustness formula using raw persisted player evidence';
