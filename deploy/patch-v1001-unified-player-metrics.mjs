...
fs.writeFileSync(paths.tableMarker,JSON.stringify({version:'0.11.0',renderer:'v1000-rating',schema:['PLAYER','CONTACT','HOME','BULLSHOOTER','BS CURRENT','BS50','BS20','BS10','CAMARILLO','NEXUS RATING','ROBUSTNESS','ACTIONS'],repairsLegacyHeaders:['BS30','RATING','CAMARILLO'],statCells:{bsCurrent:4,bs50:5,bs20:6,bs10:7,camarillo:8,nexusRating:9,robustness:10,actions:11},rowMatch:['bullshooter-id-loose-hash','player-id','primary-unique-name']})+'\n');
